...
public class ExecuteEventLogHipsTask extends AbstractTask {

    private final String requestUrl = "http://ahnlab.com/execute/log/hips/task";
    private final String filePath = "product/hips/execute_event_log.json";

...
public class ExecuteEventLogAcTask extends AbstractTask {

    private final String requestUrl = "http://ahnlab.com/execute/log/ac/task";
    private final String filePath = "product/ac/execute_event_log.json";
